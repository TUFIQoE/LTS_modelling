...
conditions_clean <- list(
  clean_all_weeks = list(clean_data$n < 8, clean_data$week < 26),
  clean_is7_weeks = list(clean_data$n == 7, clean_data$week < 26),
  clean_less7_weeks = list(clean_data$n < 7, clean_data$week < 26),
